...
def main() -> int:
    ...
    parser.add_argument('-arwf', "--analyze-relative-word-frequency", action='store_true')
    ...
    instruction_count = 0
    instructions = ['summary', 'table', 'count_words', 'analyze_relative_word_frequency', 'auto_count_words']
